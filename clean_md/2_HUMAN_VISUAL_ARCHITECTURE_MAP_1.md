---
source: 2_HUMAN_VISUAL_ARCHITECTURE_MAP.md
type: markdown
cleaned: 2026-09-11
...
└──────────────────────────┘                                                                │
                                              ...
                                              │ 05_episodic_logs/red_audit_sandbox/                    │
                                              ├────────────────────────────────────────────────────────┤
...
Tier
	...
	Cross-Auditor & Red Auditor Agents
	Multi-model traces (trajectories/), sync batches (daily_driver_sync/), audit logs (red_audit_sandbox/), verifier scores (rlvr_verifiers/).
...
3. Database Grounding Check: Confirm that the Cross-Auditor evaluated script outputs against the universal database before passing files to the Red Auditor.
Check 5: Sandboxed Red Auditor Gatekeeper
Inspect 05_episodic_logs/red_audit_sandbox/:
* Confirm that no script was uploaded to the cloud without a corresponding VERDICT_APPROVED record.
* Check rejected scripts in 05_episodic_logs/red_audit_sandbox/rejected_*.jsonl:
...
📦 vault_root/
 ...
 └── 📁 05_episodic_logs/                # 🔴 [TIER 5: EPISODIC TELEMETRY] Trajectories & RLVR Audits
     ...
     ├── 🛑 red_audit_sandbox/           #   ├── Red Auditor evaluations & quarantine reports
