...
checked: 2026-09-09
source: 01-sources/whyyoucodevoicelikeass/Fixitnowpaigow.txt
cleaned: 02-clean/whyyoucodevoicelikeass/fixitnowpaigow.md
source_kind: text
...
# Check — whyyoucodevoicelikeass/Fixitnowpaigow.txt
...
| bytes | 4260 |
| atoms judged | 19 |
| atoms set aside (fused by the checker's own extractor) | 15 |
| segments checked | 31 |
