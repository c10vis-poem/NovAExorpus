---
source: verification_guide_mobile.md
type: markdown
cleaned: 2026-09-10
cleaner: tools/clean.py (mutool)
---

﻿That screenshot shows the exact problem: mobile Markdown renderers clip tables horizontally, cutting off the third column completely and squishing inline paths like 02_wiki_md/ into broken snippets like 0:.
To fix this completely:
1. Zero Markdown tables: The verification guide is converted into a clean, mobile-proof card list that cannot be clipped.
2. Dedicated Copy Blocks: Every section is wrapped in its own code block so you get the one-tap "Copy" button for each piece.
3. Strict 40-character line limit: Nothing will wrap or break when pasted into Google Docs.
...
[CHECK 5: RED AUDITOR GATEKEEPER]
