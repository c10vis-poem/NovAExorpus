...
checked: 2026-09-09
source: 01-sources/AESOP_XI_/Local-first code intelligence graph..txt
cleaned: 02-clean/AESOP_XI_/local-first-code-intelligence-graph.md
source_kind: text
...
# Check — AESOP_XI_/Local-first code intelligence graph..txt
