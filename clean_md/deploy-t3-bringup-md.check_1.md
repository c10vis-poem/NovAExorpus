...
checked: 2026-09-09
source: 01-sources/AESOP_XI_/deploy∕T3-BRINGUP.md.txt
cleaned: 02-clean/AESOP_XI_/deploy-t3-bringup-md.md
source_kind: text
...
# Check — AESOP_XI_/deploy∕T3-BRINGUP.md.txt
...
| bytes | 3921 |
| atoms judged | 61 |
| atoms set aside (fused by the checker's own extractor) | 26 |
| segments checked | 57 |
