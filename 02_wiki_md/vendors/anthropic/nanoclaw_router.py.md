...
2. Implements the Hybrid Architectural Spine:
   ...
   - "mem-search": Dynamic, on-demand lookup against #d.u.m.b.a.s.s. & local manifest.jsonl
files.
3. Dynamically hot-loads relevant tools (from 04_skills_runtime/extracted_tools) and skills (from
prompt_skills).
4. Emits compressed, token-optimized context blocks for Claude Code CLI or Prime Agent
runtime.
"""
