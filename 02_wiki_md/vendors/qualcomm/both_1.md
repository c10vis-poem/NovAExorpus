...
Run python log_builder.py on your phone to create your first clean data rows.

Run your ./sync_and_grep.sh script to test searching through both your new logs and your updated skills.md prompt variable rules.
