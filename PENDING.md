...
- **Other 6 repos still POINTER.md stubs.** `novus-aexenti`, `novaexopia`, `aesop-xi`, `horizons-ui`, `novus-aesc`, `novus-aeyre` haven't had their own ingestion pass — only `novae-xorpus` itself has real `clean_md`/`wiki_md` content.
